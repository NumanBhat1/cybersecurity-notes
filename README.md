...
| SIEM | [Splunk SPL cheatsheet](siem/splunk-spl-cheatsheet.md) |
| MITRE ATT&CK | [Framework basics](mitre/attack-basics.md) |

## Why I keep these

A SOC analyst lives in logs, networking, and detection. Writing these notes is how
I move concepts from "I read it once" to "I can explain and use it." If something
here is wrong or out of date, corrections are welcome.
